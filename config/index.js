...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxc66afb2a7b7b317f',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '30682e3d12466a1a870562dc535b3d85',
  ...
  USERS: [
    {
      ...
      id: 'oTVHL5xGOXWX4A1CKMh329MxAkdQ',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '7umWj9KUDn6rvr7BElB3u6B4aK8rKM_qjVTLQkYQLC0',
      // 所在省份
      province: '北京',
      // 所在城市
      city: '北京',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '小乐宝', year: '2002', date: '01-02',
        },
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2019-01-19' } //,
        // 结婚纪念日
  ...
  CALLBACK_TEMPLATE_ID: '7umWj9KUDn6rvr7BElB3u6B4aK8rKM_qjVTLQkYQLC0',
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oTVHL55lbMu0Clv9AHujsxbf9-DM'
    }
    // 你可以不断按格式往下增加
    // ...
  ],
